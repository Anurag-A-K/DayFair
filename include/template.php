...
<body class="hold-transition skin-yellow" style="width: 100%;">
<div class="wrapper">
  <header class="main-header">
    <a href="<?php echo WEB_ROOT; ?>" class="logo">
    <span class="logo-lg">DayFair</span> </a>
  ...
  <footer class="main-footer" style="background: rgb(243,156,18);color: white;">
